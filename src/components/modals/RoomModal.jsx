...
export default function RoomModal({ data, branches, rooms, defaultBranchId, onSave, onClose }) {
  ...
  }, [isEdit, data, rooms, branchId, type]);
  ...
  return (
    <>
      <ModalHeader title={isEdit ? "✏️ แก้ไขห้อง" : "➕ เพิ่มห้อง"} onClose={onClose} />
      <ModalBody>
