...
export const QUEUE_CREATE_ERROR_MESSAGES = {
  ...
  // รหัสอ้างอิงเดิมถูกใช้บันทึกสำเร็จไปแล้ว แต่ข้อมูลในฟอร์มถูกแก้หลังจากนั้น
  // เกิดตอนกดบันทึกแล้วเน็ตหลุดระหว่างทาง (คิวลงไปแล้วแต่หน้าจอไม่รู้) แล้วแอดมินแก้ฟอร์มกดใหม่
  // ห้ามบอกให้ "กดใหม่อีกครั้ง" เด็ดขาด — คิวเดิมลงไปแล้ว กดใหม่จะได้สองคิว ต้องไปแก้ที่คิวเดิม
  request_id_stale: "คิวนี้ถูกบันทึกไปแล้วตั้งแต่กดครั้งก่อน (ด้วยข้อมูลชุดเดิม) สิ่งที่เพิ่งแก้ยังไม่ถูกบันทึก — ไปแก้ที่คิวเดิมในตารางคิว อย่ากดบันทึกซ้ำ เพราะจะกลายเป็นสองคิว",
