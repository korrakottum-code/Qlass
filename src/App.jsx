...
export default function App() {
  ...
  const handleBookingSubmit = useCallback(async () => {
    ...
    // เลือกก่อนบันทึกเสมอ — มีโปรสำรอง "ไม่มีส่วนลด" (ใช้ได้ทุกหัตถการ) ให้เลือกสำหรับ
    // ลูกค้าที่จ่ายเต็มราคาจริง ๆ ไม่มีส่วนลด กันไม่ให้คนกลุ่มนี้บันทึกคิวไม่ได้เลย
    //
    ...
    if (!editingQueueId && form.status !== "waiting_queue" && form.procedureId && !form.promoId) {
      showToast("error", "กรุณาเลือกโปร/แพ็กเกจ — ถ้าไม่มีส่วนลด เลือก \"ไม่มีส่วนลด\" ได้");
      return;
    }
