...
| `src/manual/testContent.js` | แบบทดสอบก่อน/หลังเทรน 30 ข้อ (`QUIZ_META`, `QUIZ_QUESTIONS`) แสดงในแท็บที่สองของหน้าคู่มือ; `npm run manual:docs` สร้าง `docs/QUIZ_PRE_POST.md` |
