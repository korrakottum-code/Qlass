...
test("ข้อความ 'ลบไม่ได้เพราะยังมีคิว' ต้องขึ้นได้ทั้งสองทาง", () => {
  // ทางตรงส่งรหัส 23503 ทางเซิร์ฟเวอร์ตอบ 409 พร้อมรหัสใน body — ถ้ารับแค่ทางเดียว
  // พอสลับทาง ข้อความจะกลายเป็น "ลองอีกครั้ง" แล้วผู้ใช้กดวนไม่จบ
  // (ตอนเขียนครั้งแรกเทียบกับ error.message ซึ่งเป็นข้อความกลาง ๆ ไม่มีวันตรง — ดู
  //  test/confirmBeforeDelete.test.js ที่ตรึงวิธีที่ถูกไว้)
